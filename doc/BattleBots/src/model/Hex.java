...
public class Hex {
    ...
    /**
     * calls the proper function to draw a certain type of robot
     *
    ...
    /**
     * this function keep tracking at where the mouse has been clicked on the
     * game board
     *
     * @param mousex the horizontal location on the game Panel where the mouse
     * clicked
     * @param mousey the vertical location on the game Panel where the mouse
     * clicked
    ...
    /**
     * This function will return a boolean value of true or false based on
     * whether or not the current Hex space is empty of any robots or not
     *
